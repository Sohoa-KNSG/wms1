...
public interface IAuthService
{
    ...
    Task<Result> ResetPasswordAsync(string adminUsername, ResetPasswordRequestDto request, string? clientIp = null, string? userAgent = null, CancellationToken cancellationToken = default);
